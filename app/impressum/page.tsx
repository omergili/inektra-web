    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pr-96">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">Registereintrag:</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">Umsatzsteuer:</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-4">Haftung für Links</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-4">Urheberrecht</h2>
          <p>
