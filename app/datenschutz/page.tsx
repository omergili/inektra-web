    ...
    <div className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold mt-12 mb-4">2. Hosting</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-4">3. Allgemeine Hinweise und Pflichtinformationen</h2>
          <h3 className="text-xl font-semibold mt-6 mb-3">Verantwortliche Stelle</h3>
          <p>
