...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-32 pb-20 min-h-[500px] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pr-96">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Link href="/messgeraete-kalibrieren" className="group block p-8 rounded-xl bg-white border border-slate-200 hover:border-accent-300 hover:shadow-xl transition-all duration-300">
              <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-accent-600 transition-colors break-words hyphens-auto">Messmittelkalibrierung</h3>
